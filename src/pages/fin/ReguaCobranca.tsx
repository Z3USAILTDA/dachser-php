    ...
    >
      ...
      <div className="flex flex-wrap items-center gap-[10px] mb-[18px]">
        ...
        <span className="px-3 py-2 rounded-full bg-white/6 border border-white/12 text-[#ddd] text-[0.85rem] inline-flex items-center gap-[6px]">
          ...
          <span>Última atualização:</span> {dbStats?.lastUpdate ? (() => { try { const d = new Date(dbStats.lastUpdate.replace('Z', '')); return d.toLocaleDateString('pt-BR', { day: '2-digit', month: '2-digit', year: 'numeric' }); } catch { return "N/A"; } })() : "..."}
        </span>
