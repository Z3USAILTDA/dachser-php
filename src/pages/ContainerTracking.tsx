...
import { Search, RefreshCw, Ship, Trash2, Mail, Check, ArrowLeft, Loader2, Anchor, AlertTriangle, HelpCircle, ChevronDown, ChevronUp, Package, Clock, Bell, Play, Database, Radar, RotateCcw, Sun, Moon, FileSpreadsheet, BoxIcon, ArrowLeftRight, Hash, Plus, Minus, FilePlus } from "lucide-react";
        ...
        <div className="flex items-center gap-[18px]">
          ...
          <header>
            ...
            <p className="text-[0.9rem] text-[#aaaaaa] mt-0.5">
              Intelligent Logistics – Monitoramento FCL / LCL
            </p>
