        ...
        <main className="relative z-10 pt-20 pb-16 px-4">
          ...
          <div className="flex justify-center items-start gap-2.5 px-3">
            {filteredMenuItems.map((item) => (
              <div key={item.id} className="relative flex flex-col items-center" style={{ width: "162px" }}>
                {/* Card */}
                <div
                            ...
                            {child.expandableId ? (
                              <div className="relative mt-2.5 flex flex-col items-center w-full">
                                <button
                                  onClick={() => {
                                    setExpandedSubChild(null);
                                    setExpandedChild(expandedChild === child.expandableId ? null : child.expandableId!);
                                  }}
