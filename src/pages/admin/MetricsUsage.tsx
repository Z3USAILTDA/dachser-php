...
const MetricsUsage = () => {
  ...
  const getMethodClass = (method: string) => {
    const { tone } = prettifyMethod(method);
    switch (tone) {
      case "in":     return "bg-emerald-500/15 border-emerald-500/60 text-emerald-400";
      case "out":    return "bg-blue-500/12 border-blue-500/40 text-blue-400";
      case "view":   return "bg-white/8 border-white/20 text-foreground/70";
      case "action": return "bg-primary/10 border-primary/90 text-primary";
      case "delete": return "bg-red-500/12 border-red-500/90 text-red-400";
