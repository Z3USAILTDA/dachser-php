...
const EsteiraVoucherDetails = () => {
  ...
  const getEtapaBadgeColor = (etapa: string) => {
    switch (etapa) {
      ...
      case "CANCELADO": return "bg-gray-500/20 text-gray-400 line-through";
        ...
        >
          ...
          <TabsContent value="detalhes" className="space-y-6">
            {/* Voucher Details */}
              ...
              canEditFields={["RASCUNHO","A_PROCESSAR","OPERACAO","AJUSTE_OPERACAO"].includes(voucher.etapaAtual as string)}
            />
