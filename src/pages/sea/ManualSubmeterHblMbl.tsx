...
const sections: Section[] = [
  ...
  { id: 'comparacao', title: 'Comparação HBL × MBL', icon: <GitCompare className="h-4 w-4" /> },
...
const faqItems = [
  { 
    q: 'O que é a comparação HBL × MBL?', 
    a: 'É a análise que verifica se os dados do House BL correspondem corretamente ao Master BL.' 
  },
  { 
    q: 'Quais campos são comparados?', 
    a: 'Container, consignee, peso, volume, descrição da mercadoria e dados do embarcador.' 
  },
  { 
    q: 'O que fazer quando há divergência?', 
    a: 'Revise os documentos originais e corrija as informações antes de prosseguir com o embarque.' 
  },
  { 
    q: 'Posso submeter novamente?', 
    a: 'Sim, você pode resubmeter quantas vezes necessário. Cada análise fica no histórico.' 
  },
];

const glossaryItems = [
  { term: 'HBL', definition: 'House Bill of Lading - Conhecimento emitido pelo freight forwarder.' },
  { term: 'MBL', definition: 'Master Bill of Lading - Conhecimento emitido pela companhia marítima.' },
  { term: 'Divergência', definition: 'Diferença encontrada entre dados do HBL e MBL.' },
  { term: 'Match', definition: 'Correspondência correta entre dados comparados.' },
];

export default function ManualSubmeterHblMbl() {
  ...
  return (
    <PageLayout title="DACHSER" subtitle="Manual — Submeter HBL × MBL v1.0" backTo="/sea/submeter-hbl-mbl" pageIcon={BookOpen}>
          ...
          <section ref={el => sectionRefs.current['visao-geral'] = el} id="visao-geral">
            <Card className="bg-[rgba(5,6,18,0.9)] border-white/12">
              ...
              <CardContent className="space-y-4 text-white/80">
                <p>
                  A tela <strong className="text-amber-300">Submeter HBL × MBL</strong> permite comparar 
                  documentos House Bill of Lading com Master Bill of Lading para identificar divergências.
                </p>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                  <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                    <GitCompare className="h-8 w-8 text-amber-400 mb-2" />
                    <h4 className="text-white font-medium mb-1">Comparação</h4>
                    <p className="text-xs text-white/60">Analisa HBL vs MBL</p>
                  </div>
                  <div className="p-4 rounded-lg bg-white/5 border border-white/10">
            ...
            <Card className="bg-[rgba(5,6,18,0.9)] border-white/12">
              ...
              <CardContent className="space-y-4 text-white/80">
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-4 w-4 text-green-400 mt-0.5 shrink-0" />
                    <span><strong>Consignee:</strong> Destinatário da carga</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-4 w-4 text-green-400 mt-0.5 shrink-0" />
                    <span><strong>Peso:</strong> Peso bruto declarado</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-4 w-4 text-green-400 mt-0.5 shrink-0" />
                    <span><strong>Volume:</strong> Cubagem da carga</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-4 w-4 text-green-400 mt-0.5 shrink-0" />
                    <span><strong>Descrição:</strong> Descrição da mercadoria</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4 text-white/80">
                ...
                <div className="mt-4 p-3 rounded bg-amber-500/10 border border-amber-500/20">
                  <p className="text-sm text-amber-300">
                    <strong>Importante:</strong> Corrija divergências antes de prosseguir com o embarque.
                  </p>
                </div>
              </CardContent>
            </Card>
