...
const sections: Section[] = [
  ...
  { id: 'upload', title: 'Upload de Manifest', icon: <Upload className="h-4 w-4" /> },
  { id: 'formatos', title: 'Formatos Aceitos', icon: <FileText className="h-4 w-4" /> },
  { id: 'processamento', title: 'Processamento', icon: <FileSpreadsheet className="h-4 w-4" /> },
...
const faqItems = [
  { 
    q: 'O que é um Manifest?', 
    a: 'É o documento que lista todas as cargas embarcadas em um navio, com detalhes de cada HBL.' 
  },
  { 
    q: 'Quais formatos são aceitos?', 
    a: 'São aceitos arquivos PDF e Excel (XLSX, XLS). Excel é preferido para melhor extração de dados.' 
  },
  { 
    q: 'Como o sistema processa o Manifest?', 
    a: 'O sistema extrai automaticamente a lista de HBLs, containers e consignees do arquivo.' 
  },
  { 
    q: 'Posso atualizar um Manifest já cadastrado?', 
    a: 'Sim, faça upload de uma nova versão e o sistema atualizará os dados.' 
  },
];
...
const glossaryItems = [
  ...
  { term: 'MBL', definition: 'Master Bill of Lading - Conhecimento principal do navio.' },
  { term: 'Consignee', definition: 'Destinatário da carga.' },
];

export default function ManualCadastroManifest() {
  ...
  return (
    <PageLayout title="DACHSER" subtitle="Manual — Cadastro de Manifest v1.0" backTo="/sea/cadastro-manifest" pageIcon={BookOpen}>
          ...
          <section ref={el => sectionRefs.current['visao-geral'] = el} id="visao-geral">
            <Card className="bg-[rgba(5,6,18,0.9)] border-white/12">
              ...
              <CardContent className="space-y-4 text-white/80">
                <p>
                  A tela <strong className="text-amber-300">Cadastro de Manifest</strong> permite fazer 
                  upload de documentos Manifest para processamento e análise documental.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                  <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                    ...
                    <p className="text-xs text-white/60">Faça upload do Manifest</p>
                  </div>
                  <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                    <FileSpreadsheet className="h-8 w-8 text-amber-400 mb-2" />
                    <h4 className="text-white font-medium mb-1">Extração</h4>
                    <p className="text-xs text-white/60">Lista de HBLs extraída automaticamente</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4 text-white/80">
                <div className="space-y-2">
                  {[
                    ...
                    'Aguarde a extração automática dos HBLs',
                    'Verifique a lista de cargas identificadas',
                    'O Manifest estará pronto para análise'
                  ].map((etapa, i) => (
              ...
              <CardContent className="space-y-4 text-white/80">
                ...
                <div className="mt-4 p-3 rounded bg-green-500/10 border border-green-500/20">
                  <p className="text-sm text-green-300">
                    <strong>Recomendado:</strong> Use arquivos Excel para melhor extração de dados tabulares.
                  </p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4 text-white/80">
                ...
                <ul className="space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Lista de todos os HBLs no manifest</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-4 w-4 text-green-400 mt-0.5 shrink-0" />
                    <span>Números de containers associados</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-4 w-4 text-green-400 mt-0.5 shrink-0" />
                    <span>Consignees de cada carga</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-4 w-4 text-green-400 mt-0.5 shrink-0" />
                    <span>Detalhes de peso e volume</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
