  ...
  return <div className="min-h-screen relative overflow-x-hidden">
      ...
      <div className="relative z-10 max-w-[95%] mx-auto px-2 pt-5 pb-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-[18px]">
          ...
          <header>
            ...
            <p className="text-[0.9rem] text-[#aaaaaa] mt-0.5">Intelligent Logistics – Status Doc Exportação</p>
        ...
        <div className="flex items-center gap-2.5 text-[0.85rem]">
          ...
          <div className="w-8 h-8 rounded-full border border-[rgba(255,255,255,.25)] flex items-center justify-center bg-[rgba(0,0,0,.7)] text-[#ffc800]" title="Status Doc Exportação">
            <Ship size={16} />
          </div>
        </div>
      </div>
      ...
      <main className="relative z-10 max-w-[95%] mx-auto px-2 pb-8">
        <div className="space-y-6">
          ...
          {/* Tab Content */}
          {activeTab === "grid" && <DraftDataGrid data={combinedData} onRefresh={refetch} isLoading={isLoading} statusFilter={statusFilter} onStatusFilterChange={setStatusFilter} />}

          {activeTab === "tracker" && <HapagTrackerPanel onSave={refetch} />}
