                          ...
                          <td className="px-4 py-3 text-center">
                            <div className="flex items-center justify-center gap-1">
                              ...
                              {(() => {
                                ...
                                return trackingUrl ? (
                                  <TooltipProvider><Tooltip><TooltipTrigger asChild>
                                    <Button variant="ghost" size="sm" onClick={() => <Button variant="ghost" size="sm" onClick={() => window.open(trackingUrl, "_blank", "noopener,noreferrer")} className="text-foreground hover:text-primary h-8 w-8 p-0">} className="text-foreground hover:text-primary h-8 w-8 p-0">
