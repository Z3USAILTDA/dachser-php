...
export default function SupervisorRejectRedirect() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-rose-950 flex items-center justify-center px-4 py-10">
        ...
        <CardContent className="p-8">
          <div className="flex flex-col items-center text-center">
            <div className="mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-rose-100">
              <XCircle className="h-11 w-11 text-rose-600" />
            </div>

            <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-rose-200 bg-rose-50 px-3 py-1 text-sm font-medium text-rose-700">
              <ShieldAlert className="h-4 w-4" />
              Ambiente seguro Dachser
            </div>

            <h1 className="text-2xl font-bold tracking-tight text-slate-950 md:text-3xl">
              Rejeição do supervisor
            </h1>

            <p className="mt-3 max-w-md text-sm leading-6 text-slate-600">
              Estamos direcionando você para a tela de confirmação da rejeição.
            </p>
