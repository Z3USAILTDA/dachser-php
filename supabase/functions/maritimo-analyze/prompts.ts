...
Followed by the PER-EXPORTER ANALYSIS (MANDATORY STRUCTURE).
...
EXPORTER #2: <NEXT_EXPORTER_NAME>
   [Same complete structure as above - ALL fields with values and status]


[Continue for ALL exporters found in the Manifest]
...
Total Gross Weight: Manifest = <#,###.000 kg> | HBL(s) = <#,###.000 kg>
   ...
   [If UPDATE REQUIRED: -> Update HBL weights so total equals <manifest value>]

Total CBM: Manifest = <#,###.000 m3> | HBL(s) = <#,###.000 m3>
   Status: <MATCH | UPDATE REQUIRED>
   [If UPDATE REQUIRED: -> Update HBL CBM so total equals <manifest value>]

Total Volumes: Manifest = <N> | HBL(s) = <N>
   Status: <MATCH | UPDATE REQUIRED>
   [If UPDATE REQUIRED: -> Update HBL volumes so total equals <manifest value>]
...
Container Number:
   ...
   Status: <MATCH | UPDATE REQUIRED>
   [If UPDATE REQUIRED: -> Update: Set HBL container number to <manifest value>]
...
[Continue for ALL exporters found in the Invoices]
