  ...
  try {
    ...
    if (action === 'bulk_manual_update_sea') {
      ...
      try {
        ...
        await updateMain('HLCUBKK260146220', { last_event: 'Vessel departed - YANTIAN', navio: 'ZIM BANGKOK', status: 'DEP', origem: 'LAEM CHABANG', destino: 'SANTOS' });
        ...
        await updateMain('HLCUBKK260144320', { last_event: 'Vessel departed - YANTIAN', navio: 'ZIM BANGKOK', status: 'DEP' });
        ...
        await updateMain('HLCUBKK260143931', { last_event: 'Vessel departed - YANTIAN', navio: 'ZIM BANGKOK', status: 'DEP' });
        ...
        await updateMain('HLCUBI1260201194', { last_event: 'Vessel departed - VALENCIA', navio: 'MSC MELINE', status: 'DEP' });
        ...
        await updateMain('HLCUBI1260201201', { last_event: 'Vessel departed - VALENCIA', navio: 'MSC MELINE', status: 'DEP' });
